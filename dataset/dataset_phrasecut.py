...
import sys
sys.path.append('/workspace/cvml_user/namin/ris')
...
class PhraseCutDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_dir = f'/workspace/cvml_user/namin/ris/PhraseCutDataset/data/VGPhraseCut_v0/images/{image_id}.jpg'
        ...
        sam_img = cv2.resize(sam_img, (width, height))
