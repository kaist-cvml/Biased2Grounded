...
def main(args, Height, Width):
        ...
        if lang_dic:
            ...
            for iii in range(num_sentences):
                for lang in languages:
                    ...
                    sent_features = Model.model.get_text_features(**sentence_token)
                    ...
                    noun_features = Model.model.get_text_features(**noun_phrase_token)

                    text_ensemble = r * sent_features + (1-r) * noun_features
    ...
    df.to_csv(f"./result_log/per_instance_multilingual_siglip2_{args.dataset}_{args.split}_{i}_separate_cost.csv", index=False)
    print("Saved per-instance CSV:", f"./result_log/per_instance_multilingual_siglip2_{args.dataset}_{args.split}_{i}_separate_cost.csv")
