...
def main(args, Height, Width):
    ...
    df.to_csv(f"./result_log/per_instance_multilingual_siglip2_{args.dataset}_{args.split}_{i}.csv", index=False)
    print("Saved per-instance CSV:", f"./result_log/per_instance_multilingual_siglip2_{args.dataset}_{args.split}_{i}.csv")

    f = open('./result_log/result_log_Multilingual_siglip2.txt', 'a')
